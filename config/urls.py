...
from notes.views import (
    ...
    public_notes_list,public_note_create,rate_note,add_comment,delete_comment,purchase_note
)
...
urlpatterns = [
    ...
    path('rate/<int:note_id>/', rate_note, name='rate_note'),
    path('comment/<int:note_id>/', add_comment, name='add_comment'),
    path('comment/delete/<int:comment_id>/', delete_comment, name='delete_comment'),
    path('purchase/<int:note_id>/', purchase_note, name='purchase_note')
]
